...
/**
 * Padrinho form base class.
 *
 * @method Padrinho getObject() Returns the current form's model object
 *
 * @package    abrigo
 * @subpackage form
 ...
 */
abstract class BasePadrinhoForm extends PessoaForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['interessePreliminar'] = new sfWidgetFormTextarea();
    $this->validatorSchema['interessePreliminar'] = new sfValidatorString(array('max_length' => 4000, 'required' => false));
    ...
    $this->widgetSchema->setNameFormat('padrinho[%s]');
  }
