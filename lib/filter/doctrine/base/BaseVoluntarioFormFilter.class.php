 ...
 */
abstract class BaseVoluntarioFormFilter extends PessoaFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema   ['disponibilidadeHorario'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['disponibilidadeHorario'] = new sfValidatorPass(array('required' => false));

    $this->widgetSchema   ['atividadeDesenvolvida'] = new sfWidgetFormFilterInput();
    $this->validatorSchema['atividadeDesenvolvida'] = new sfValidatorPass(array('required' => false));
