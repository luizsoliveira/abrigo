...
/**
 * MotivoIngresso filter form base class.
 *
 * @package    abrigo
 * @subpackage filter
 ...
 */
abstract class BaseMotivoIngressoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('motivo_ingresso_filters[%s]');
