...
/**
 * MotivoDesligamento filter form base class.
 *
 * @package    abrigo
 * @subpackage filter
 ...
 */
abstract class BaseMotivoDesligamentoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('motivo_desligamento_filters[%s]');
